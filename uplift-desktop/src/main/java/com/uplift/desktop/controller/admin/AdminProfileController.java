...
public class AdminProfileController {
    ...
    public void init(LoginResponse resp) {
        if (resp == null) {
            AlertUtils.showError("Profile Error", "Session not found. Please login again.");
            return;
        }
        this.session = resp;

        String name = resp.getFullName() != null ? resp.getFullName() : "Admin User";
        String role = resp.getRole() != null ? resp.getRole() : "ADMIN";
